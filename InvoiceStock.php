...
$sql = mysql_query("SELECT * FROM stock_master AS m LEFT JOIN clients AS c ON c.clientId = m.clientId WHERE m.invoiceNo = '$invNo'");
$row = mysql_fetch_array($sql);

$sqls = mysql_query("SELECT * FROM stock_details AS d LEFT JOIN products AS p ON p.id = d.productCode 
LEFT JOIN brand AS b
ON b.brand_id = p.brand_id
LEFT JOIN model AS m
ON m.model_id = p.model_id
WHERE invoiceNo = '$invNo' ORDER BY d.id");
