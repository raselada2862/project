...
if($rowd == 0){
	...
	if($inv_no != ''){
		...
		$query = ("INSERT INTO $tbl_name (clientId, challanNo, invoiceNo, invoiceDate, invoiceNote, discount, paidAmount, EntBy, EntDate) VALUES ('$clientId', '$challanNo', '$inv_no', '$invoiceDate', '$invoiceNote', '$discount', '$paidAmount', '$EntBy', '$EntDate')");
