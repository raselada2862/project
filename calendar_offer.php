	...
	$(document).ready(function() {
        ...
        <div class="" style="height:850px">
                ...
                <div class="navg_month">
                	    <a href="OfferReminder?m=1" class="month">Jan</a>
                        <span class="seprator">|</span>
                        <a href="OfferReminder?m=2" class="month">Feb</a>
                        <span class="seprator">|</span>
                        <a href="OfferReminder?m=3" class="month">Mar</a>
                        <span class="seprator">|</span>
                        <a href="OfferReminder?m=4" class="month">Apr</a>
                        <span class="seprator">|</span>
                        <a href="OfferReminder?m=5" class="month">May</a>
                        <span class="seprator">|</span>
                        <a href="OfferReminder?m=6" class="month">Jun</a>
                        <span class="seprator">|</span>
                        <a href="OfferReminder?m=7" class="month">Jul</a>
                        <span class="seprator">|</span>
                        <a href="OfferReminder?m=8" class="month">Aug</a>
                        <span class="seprator">|</span>
                        <a href="OfferReminder?m=9" class="month">Sep</a>
                        <span class="seprator">|</span>
                        <a href="OfferReminder?m=10" class="month">Oct</a>
                        <span class="seprator">|</span>
                        <a href="OfferReminder?m=11" class="month">Nov</a>
                        <span class="seprator">|</span>
                        <a href="OfferReminder?m=12" class="month">Dec</a>
				</div>
						...
						for($i = 0; $i <= 5; $i ++) {
							...
							for($j= 0; $j <= 6; $j++) {
							    ...
							    if($currElem < $startDay && !$firstDayHasCome)	{		
									...
									echo("<a href='fpdf/OfferReminder?date=".$divId."' target='_blank'>");
									echo("<div class=\"top\">\r\n");
