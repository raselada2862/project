	...
	$(document).ready(function() {
        ...
        <div class="" style="height:850px">
                ...
                <div class="navg_month">
                	    <a href="WorkSchedule?m=1" class="month">Jan</a>
                        <span class="seprator">|</span>
                        <a href="WorkSchedule?m=2" class="month">Feb</a>
                        <span class="seprator">|</span>
                        <a href="WorkSchedule?m=3" class="month">Mar</a>
                        <span class="seprator">|</span>
                        <a href="WorkSchedule?m=4" class="month">Apr</a>
                        <span class="seprator">|</span>
                        <a href="WorkSchedule?m=5" class="month">May</a>
                        <span class="seprator">|</span>
                        <a href="WorkSchedule?m=6" class="month">Jun</a>
                        <span class="seprator">|</span>
                        <a href="WorkSchedule?m=7" class="month">Jul</a>
                        <span class="seprator">|</span>
                        <a href="WorkSchedule?m=8" class="month">Aug</a>
                        <span class="seprator">|</span>
                        <a href="WorkSchedule?m=9" class="month">Sep</a>
                        <span class="seprator">|</span>
                        <a href="WorkSchedule?m=10" class="month">Oct</a>
                        <span class="seprator">|</span>
                        <a href="WorkSchedule?m=11" class="month">Nov</a>
                        <span class="seprator">|</span>
                        <a href="WorkSchedule?m=12" class="month">Dec</a>
				</div>
						...
						for($i = 0; $i <= 5; $i ++) {
							...
							for($j= 0; $j <= 6; $j++) {
							    ...
							    if($currElem < $startDay && !$firstDayHasCome)	{		
									...
									echo("<a href='WorkScheduleMy?date=".$divId."' target='_blank'>");
									echo("<div class=\"top\">\r\n");
